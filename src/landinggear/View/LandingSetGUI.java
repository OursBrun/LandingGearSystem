        ...
        if (o instanceof Sensors) {
         ...
         int gp = S.getLs().getG().getPosition();   
            ...
            if(dp==0 && gp==0){
                ...
                this.WheelsState.setText("Les roues sont remontées");
               ...
               this.DoorState.setText("La Porte est fermée");
                this.WheelsState.setText("Les roues sont sorties");
                this.Orange.setBackground(Color.WHITE);
                this.Red.setBackground(Color.WHITE);
             ...
             if (gp==1) {
                 if(dp==0){
                this.DoorState.setText("La Porte est fermée");
                this.WheelsState.setText("Les roues sont en mouvement");
                this.Orange.setBackground(Color.ORANGE);
                this.Red.setBackground(Color.WHITE);
                this.Green.setBackground(Color.WHITE);
                System.out.println("Le train d'attérissage est cours de déploiement");
                 }
                 if(dp==2){
